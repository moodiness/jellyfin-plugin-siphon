...
def package(output, release_url, timestamp):
    ...
    release = {
        ...
        "timestamp": timestamp,
        "changelog": "Virtual Jellyfin home channel architecture with mixed catalogs, artwork, metadata, subtitles and server-side playback."
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--release-url", default="https://github.com/moodiness/jellyfin-plugin-siphon/releases/download/v1.1.0")
