...
1. Download `siphon-1.2.0.0.zip` from the [v1.2.0 release](https://github.com/moodiness/jellyfin-plugin-siphon/releases/tag/v1.2.0).
2. Verify the archive against `SHA256SUMS`.
3. Create a versioned folder named `Jellyfin.Plugin.Siphon_1.2.0` inside Jellyfin's plugin directory and extract the archive contents into that folder. The folder must contain `Jellyfin.Plugin.Siphon.dll` and `meta.json`.
4. Restart Jellyfin.
